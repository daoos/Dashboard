<template lang="html">
  <div class="bi-table-repeat bi-table">
    <el-table :data="data" border align="center" width="1500">
      ...
      <el-table-column prop="_source.last_month_task_available_hospital" label="重复购进信使负责终端数" width="120"></el-table-column>
      <el-table-column prop="_source.last_month_task_assign_hospital" label="重复购进信使可负责终端数" width="120"></el-table-column>
      <el-table-column prop="_source.last_month_sales_hospital" label="重复购进终端数" width="120"></el-table-column>
    </el-table>
